...
sealed class UiQuantityType(
    ...
    object None :
        UiQuantityType(
            R.string.all_select,
            R.plurals.all_plurals_quantity_none,
            R.string.all_quantity_none
        )
}
