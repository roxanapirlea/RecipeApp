...
@Composable
fun AddRecipeTimeScreen(
    addRecipeTimeViewModel: AddRecipeTimeViewModel,
    onBack: () -> Unit = {},
    onForward: () -> Unit = {},
    onNavigate: (PageType) -> Unit = {},
) {
    val state by rememberFlowWithLifecycle(addRecipeTimeViewModel.state)
        .collectAsState(AddRecipeTimeViewState())

    AddRecipeTimeView(
        state,
        addRecipeTimeViewModel.sideEffectFlow,
        onCookingChange = addRecipeTimeViewModel::onCookingChanged,
        onPreparationChange = addRecipeTimeViewModel::onPreparationCookingChanged,
        onWaitingChange = addRecipeTimeViewModel::onWaitingChanged,
        onTotalChange = addRecipeTimeViewModel::onTotalChanged,
        onComputeTotal = addRecipeTimeViewModel::onComputeTotal,
        onValidate = addRecipeTimeViewModel::onValidate,
        onSaveAndGoBack = addRecipeTimeViewModel::onSaveAndBack,
        onBackNavigation = onBack,
        onForwardNavigation = onForward,
        onSelectPage = addRecipeTimeViewModel::onSelectPage,
...
fun AddRecipeTimeView(
    state: AddRecipeTimeViewState,
    sideEffectsFlow: Flow<AddRecipeTimeSideEffect> = flow { },
        ...
        Box(Modifier.fillMaxSize()) {
            ...
            Column(
                ...
                Row(
                    ...
                    LabelView(text = stringResource(R.string.add_recipe_time_label))
                }
                ...
                Row(
                    ...
                    RecipeTextField(
                        ...
                        label = stringResource(R.string.add_recipe_time_cooking_hint),
                    ...
                    RecipeTextField(
                        ...
                        label = stringResource(R.string.add_recipe_time_preparation_hint),
                        keyboardType = KeyboardType.Number,
                        textStyle = MaterialTheme.typography.body1,
                        imeAction = ImeAction.Next,
                    ...
                    RecipeTextField(
                        ...
                        label = stringResource(R.string.add_recipe_time_waiting_hint),
                        keyboardType = KeyboardType.Number,
                        textStyle = MaterialTheme.typography.body1,
                        imeAction = ImeAction.Next,
                ...
                Row(
                    ...
                    RecipeTextField(
                        ...
                        label = stringResource(R.string.add_recipe_time_total_hint),
                        keyboardType = KeyboardType.Number,
                        textStyle = MaterialTheme.typography.body1,
...
fun AddRecipeTimeViewPreview() {
    RecipeTheme {
        AddRecipeTimeView(AddRecipeTimeViewState())
    }
}
