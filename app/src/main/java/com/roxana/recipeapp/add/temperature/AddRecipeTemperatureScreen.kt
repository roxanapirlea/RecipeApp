...
@Composable
fun AddRecipeTemperatureScreen(
    addRecipeTemperatureViewModel: AddRecipeTemperatureViewModel,
    onBack: () -> Unit = {},
    onForward: () -> Unit = {},
    onNavigate: (PageType) -> Unit = {},
) {
    val state by rememberFlowWithLifecycle(addRecipeTemperatureViewModel.state)
        .collectAsState(AddRecipeTemperatureViewState())

    AddRecipeTemperatureView(
        state,
        addRecipeTemperatureViewModel.sideEffectFlow,
        onTemperatureChanged = addRecipeTemperatureViewModel::onTemperatureChanged,
        onValidate = addRecipeTemperatureViewModel::onValidate,
        onSaveAndGoBack = addRecipeTemperatureViewModel::onSaveAndBack,
        onBackNavigation = onBack,
        onForwardNavigation = onForward,
        onSelectPage = addRecipeTemperatureViewModel::onSelectPage,
...
fun AddRecipeTemperatureView(
    state: AddRecipeTemperatureViewState,
    sideEffectsFlow: Flow<AddRecipeTemperatureSideEffect> = flow { },
        ...
        Box(Modifier.fillMaxSize()) {
            ...
            Column(
                ...
                Row(
                    ...
                    LabelView(
                        text = stringResource(
                            R.string.add_recipe_temperature_label,
                            temperatureUnit
                        )
                    )
                }
...
fun AddRecipeTemperatureViewPreview() {
    RecipeTheme {
        AddRecipeTemperatureView(AddRecipeTemperatureViewState())
    }
}
